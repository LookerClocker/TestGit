        ...
        if (coupon && coupon.length > 0) {
            ...
            for (var i = 0; i < coupon.length; i++) {
                ...
                if (coupon[i].objectId && coupon[i].objectId.length > 0) {
                    ...
                    mainDiv.style.border='1px solid rgb(238, 238, 238)';
                    ...
                    couponDetails.innerHTML = '<a style="color: #000;" href="http://mon-coupon.com/vendorname?id='+coupon[i].retailer.objectId+'">'+coupon[i].description+'</a>';
                    // couponDetails.innerHTML = '<a style="color: #000;" href="http://localhost:63342/coupon-wp-script/details.html?id='+coupon[i].retailer.objectId+'">'+coupon[i].description+'</a>';
