        ...
        if (coupon && coupon.length > 0) {
            ...
            for (var i = 0; i < coupon.length; i++) {
                ...
                if (coupon[i].objectId && coupon[i].objectId.length > 0) {
                    ...
                    document.getElementById('coupon')[0].appendChild(mainDiv);
                    ...
                    imag.src ='https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQPJM4YvjzSCCDoQdLrpE1OP4CjT6kr8P-HMy8FfTjfhMgLpjPE03WXtw';
